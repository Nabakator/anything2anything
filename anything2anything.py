...
This script provides a command-line interface for converting files within the same
...
from src.converters import ConversionError, ToolNotFoundError
from src.dispatcher import CategoryMismatchError, convert_file
...
def main(
    ...
    Examples:
        ...
        python anything2anything.py photo.heic photo.jpg

        # Convert M4A audio to MP3
        python anything2anything.py audio.m4a audio.mp3

        # Convert DOCX document to ODT
        python anything2anything.py document.docx document.odt --verbose

        # Convert with force overwrite
        python anything2anything.py input.mp4 output.mov --force
    """
